...
const checkOutPrint = () => {
    ...
    document.querySelector('#subtotal h4').textContent = String(subTotal).substring(0, 9);
    document.querySelectorAll('#total h3')[1].textContent = String(total).substring(0, 9);
